...
NETS = {'zf': ('ZF', 'ZF_faster_rcnn_houseware.caffemodel')}
...
class NodeMain:
    ...
    def __init__(self):
        ...
        args = parse_args()
        node = FasterRCNN(
            'faster_rcnn', args, conf_thresh=args.conf_thresh, nms_thresh=args.nms_thresh)
