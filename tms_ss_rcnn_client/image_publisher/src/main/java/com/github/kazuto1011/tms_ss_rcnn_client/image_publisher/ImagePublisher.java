package com.github.kazuto1011.tms_ss_rcnn_client.image_publisher;
...
public class ImagePublisher extends RosActivity
{
    private final String TAG  = "Image Publisher";
    ...
    public ImagePublisher() {
        super("Image Publisher", "Image Publisher");
    }
